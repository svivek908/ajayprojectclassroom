            ...
            <Grid item xs={12}>
              <Paper>
                ...
                <div className="container-fluid">
                  ...
                  <div className="App">
                    <br />
                    <Button onClick={() => handleClickRolesModalOpen()} variant="contained" color="primary">Add New Student</Button>
                    ...
                    <Dialog open={openRolesEditModal} onClose={handleCloseforEditModal} aria-labelledby="form-dialog-title" maxWidth={'md'}>
                      <DialogTitle id="form-dialog-title" style={{ textAlign: 'center' }}>Edit Student</DialogTitle>
                      <DialogContent>
